...
```{r}
data = read_excel("~/Google Drive/Graduate School/Self_JamesTBrown/GitHub/ECB_mass_measures/data/raw/Respirometry/Respir.xlsx")

str(data)
data$strain<-as.factor(data$strain) #set strain as ind var
data$treat<-as.factor(data$treat) #set treat as factor as ind var
data$stage<-as.factor(data$stage) #set the stage as a independent factor
...
str(data1)
#view(data1)
write.csv(data1, "/Users/JamesB/Google Drive/Graduate School/Self_JamesTBrown/GitHub/ECB_mass_measures/data/processed/data1_ECB_MASSmeasures_PEAK_WET_MASS.csv")
```
...
write.csv(data2, "/Users/JamesB/Google Drive/Graduate School/Self_JamesTBrown/GitHub/ECB_mass_measures/data/processed/data1_ECB_MASSmeasures_PEAK_WET_MASS.csv")
write.csv(data3, "/Users/JamesB/Google Drive/Graduate School/Self_JamesTBrown/GitHub/ECB_mass_measures/data/processed/data1_ECB_MASSmeasures_PEAK_WET_MASS.csv")
write.csv(data4, "/Users/JamesB/Google Drive/Graduate School/Self_JamesTBrown/GitHub/ECB_mass_measures/data/processed/data1_ECB_MASSmeasures_PEAK_WET_MASS.csv")
write.csv(data5, "/Users/JamesB/Google Drive/Graduate School/Self_JamesTBrown/GitHub/ECB_mass_measures/data/processed/data1_ECB_MASSmeasures_PEAK_WET_MASS.csv")
```
